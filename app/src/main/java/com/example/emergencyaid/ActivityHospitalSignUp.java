...
public class ActivityHospitalSignUp extends AppCompatActivity {
        ...
        msignup.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (awesomeValidation.validate()) {
                    ...
                    mAuth.createUserWithEmailAndPassword(email, password).addOnCompleteListener(ActivityHospitalSignUp.this, new OnCompleteListener<AuthResult>() {
                        @Override
                            ...
                            if (!task.isSuccessful()) {
                                ...
                                mAuth.getCurrentUser().sendEmailVerification().addOnCompleteListener(new OnCompleteListener<Void>() {
                                    ...
                                    public void onComplete(@NonNull Task<Void> task) {
                                        if (task.isSuccessful()) {
                                            Toast.makeText(ActivityHospitalSignUp.this, "Registered Successfully ! Please, check your Email for verification.", Toast.LENGTH_SHORT).show();
                                        } else {
                                            Toast.makeText(ActivityHospitalSignUp.this, task.getException().getMessage(), Toast.LENGTH_SHORT).show();
