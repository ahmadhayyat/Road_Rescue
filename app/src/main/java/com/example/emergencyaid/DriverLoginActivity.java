...
import static com.example.emergencyaid.ProfileActivity.PROFILE_DRIVER;
        ...
        firebaseAuthListener = new FirebaseAuth.AuthStateListener() {
            ...
            public void onAuthStateChanged(@NonNull FirebaseAuth firebaseAuth) {
                ...
                if(user!=null && mAuth.getCurrentUser().isEmailVerified()){
                    ProfileActivity.launch(DriverLoginActivity.this, PROFILE_DRIVER);
                    Toast.makeText(DriverLoginActivity.this, "Welcome to Road Rescue", Toast.LENGTH_SHORT).show();
                    finish();
                }
