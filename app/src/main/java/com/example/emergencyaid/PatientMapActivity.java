...
public class PatientMapActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    private Button mLogout,mRequest,mSettings,mHistory,btnfirstaid;
    ...
    protected void onCreate (Bundle savedInstanceState) {
        ...
        mSettings.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent=new Intent(PatientMapActivity.this,CustomerInformationActivity.class);
                startActivity(intent);
                return;
            }
        ...
        btnfirstaid.setOnClickListener (new View.OnClickListener () {
            @Override
            public void onClick (View v) {
                Intent intent = new Intent (getApplicationContext (),FirstAidMainActivity.class);
                startActivity (intent);
            }
        });
                ...
                new  android.app.AlertDialog.Builder(this)
                        ...
                        .setPositiveButton("OK", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                ActivityCompat.requestPermissions(PatientMapActivity.this, new String[]{Manifest.permission.ACCESS_FINE_LOCATION},1);
